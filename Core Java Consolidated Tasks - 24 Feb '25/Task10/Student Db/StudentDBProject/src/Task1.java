...
public class Task1 {
    ...
    public static void selectStudents(Connection conn) throws SQLException {
        try (Statement stmt = conn.createStatement(); ResultSet rs = stmt.executeQuery(SELECT_QUERY)) {
    ...
    public static void main(String[] args) {
        try (Connection conn = DriverManager.getConnection("jdbc:mysql://localhost:3306/SchoolDB", "root", "jashu003"); Scanner scanner = new Scanner(System.in)) {
